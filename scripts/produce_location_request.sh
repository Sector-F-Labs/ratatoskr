...
MESSAGE_TEXT=${1:-"Please share your location so I can help you better:"}
...
echo "Producing location request message to $KAFKA_OUT_TOPIC:"
...
echo "Location request message sent!"