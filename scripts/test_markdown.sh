...
# Test 2: Code blocks and inline code
...
echo -e "\n3. Testing special characters that need escaping:"
TMP_FILE3=$(mktemp)
cat > "$TMP_FILE3" << 'EOF'
{
  "trace_id": "TRACE_ID_PLACEHOLDER",
...
# Test 4: Links and URLs
echo -e "\n4. Testing links and URLs:"
TMP_FILE4=$(mktemp)
cat > "$TMP_FILE4" << 'EOF'
{
  "trace_id": "TRACE_ID_PLACEHOLDER",
...
# Test 5: Tables (markdown tables need to be handled carefully)
echo -e "\n5. Testing table-like structures:"
TMP_FILE5=$(mktemp)
cat > "$TMP_FILE5" << 'EOF'
{
  "trace_id": "TRACE_ID_PLACEHOLDER",
...
# Test 6: Complex nested formatting
echo -e "\n6. Testing complex nested formatting:"
TMP_FILE6=$(mktemp)
cat > "$TMP_FILE6" << 'EOF'
{
  "trace_id": "TRACE_ID_PLACEHOLDER",
...
# Test 7: Edge cases and problematic content
...
echo "- Test 2: Code blocks and inline code should be monospaced"
echo "- Test 3: Special characters should be properly escaped/displayed"
echo "- Test 4: Links should be clickable and formatted correctly"
echo "- Test 5: Tables should display in a readable format"
echo "- Test 6: Nested formatting should work without conflicts"
echo "- Test 7: Edge cases should not break the message formatting"
echo ""
